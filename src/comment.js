    ...
    reply: function (e) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].SEQ == 0) {
          ...
          commentEmpty.append(
            makeReReplytable(user, rid, content, time, isme, seq)
          );
        }
      }
      ...
      if (replyCount())
        totalCommentLabel
          .tool()
          .setValue("ㅤㅤ전체 댓글 " + replyCount() + " 건");
      else totalCommentLabel.tool().setValue("ㅤㅤ전체 댓글 0 건");
      /*댓글 기능*/
      ...
      $('button[btnType="edit"]').click(function (err) {
        ...
        var editBtn = this.parentElement.parentElement.querySelector(
          'button[btnType="edit"]'
        );
        var cancleBtn = this.parentElement.parentElement.querySelector(
          'button[btnType="reply"]'
        );
        var editBtnHidden = this.parentElement.parentElement.querySelector(
          'button[btnType="editHidden"]'
        );
        var cancleBtnHidden = this.parentElement.parentElement.querySelector(
          'button[btnType="replyHidden"]'
        );
        var delBtn = this.parentElement.parentElement.querySelector(
          'button[btnType="del"]'
        );
      ...
      $('button[btnType="del"]').click(function (e) {
        ...
        var content =
          this.parentElement.parentElement.querySelector("textarea").value;
      ...
      $('button[btnType="rereEdit"]').click(function (e) {
        var ta = this.parentElement.parentElement.querySelector("textarea");
        var editBtn = this.parentElement.parentElement.querySelector(
          'button[btnType="rereEdit"]'
        );
        var delBtn = this.parentElement.parentElement.querySelector(
          'button[btnType="rereDel"]'
        );
        var editBtnHidden = this.parentElement.parentElement.querySelector(
          'button[btnType="rereEditHidden"]'
        );
        var cancleBtnHidden = this.parentElement.parentElement.querySelector(
          'button[btnType="rereCancleHidden"]'
        );
      ...
      $('button[btnType="rereDel"]').click(function (e) {
        ...
        var content =
          this.parentElement.parentElement.querySelector("textarea").value;
        var seq =
          this.parentElement.parentElement.querySelector("td#reSeq").innerText;
        $ux.cjMessage.confirm("삭제하시겠습니까?", null, function () {
          $ux.request({
...
function makeCommentTable(user, content, time, rid, isme) {
  ...
  var commentTable =
    '<table id="replyIdNo' +
    rid +
    '" style="border:1px solid; height:60px; width:100%;box-shadow: 0 2px 3px 0 rgba(0, 0, 0, 0.05);table-layout:fixed;\
  border: solid 1.5px #d7dae2;  background-color: #efefef;">  <tr style="text-align:center;">\
    ...
    <td style="width:15%; color:#777777;font-family: CJONLYONENEWbodyRegular;font-size: 15px;">' +
    user +
    '</td>\
    <td style="width:58%; color:#3a3a3a;text-align:left !important;"><textarea readonly class="bmp-idea-view-common-textarea" id="commonTextareaNo' +
    rid +
    '">' +
    content +
    '</textarea></td>\
    <td style="width:10%; color:#777777;font-family: CJONLYONENEWbodyRegular;font-size: 15px;">' +
    time +
    '</td>\
    <td style="width:5%;"><button class="bmp-idea-comment-button" style="margin-right:8px;display:' +
    displayModiBtn +
    '" btnType="edit">수 정</button></td>\
	<td style="width:5%;"><button class="bmp-idea-comment-button" style="margin-right:16px; margin-left:8px;" id="repleBtnNo' +
    rid +
    '" btnType="reply">답 글</button></td>\
	<td style="width:5%;"><button class="bmp-idea-comment-button" style="margin-right:16px; margin-left:8px;display:' +
    displayModiBtn +
    '" id="repleBtnNo' +
    rid +
    '" btnType="del">삭 제</button></td>\
	...
	<td style="width:5%; display:none;"><button class="bmp-idea-comment-button" style="margin-right:16px; margin-left:8px;" btnType="replyHidden">취 소</button></td>	<td hidden>' +
    rid +
    "</td></tr></table>";
  return commentTable;
}
...
function makeReReplytable(user, rid, content, time, isme, seq) {
  ...
  border: solid 1.5px #d7dae2;  background-color: #f2f6fe;">  <tr style="text-align:center;">\
    ...
    user +
    '</td>\
    <td style="width:50%; color:#3a3a3a;text-align:left !important;"><textarea readonly class="bmp-idea-view-common-textarea-re" id="commonRETextareaNo' +
    rid +
    '">' +
    content +
    '</textarea></td>\
	<td style="width:20%; color:#777777;font-family: CJONLYONENEWbodyRegular;font-size: 15px;">' +
    time +
    '</td>\
    <td style="width:5%;"><button class="bmp-idea-comment-button" style="margin-left:4px;display:' +
    displayModiBtn +
    '" btnType="rereEdit">수  정</button></td>\
	<td style="width:5%;"><button class="bmp-idea-comment-button" style="margin-left:4px;display:' +
    displayModiBtn +
    '"btnType="rereDel">삭  제</button></td>\
